    ...
    if (reg_product.test(pageurl) && ($('div#seatshow').length==1)) {
        ...
        $(document).keydown(
            function handleKeyPress(e) {
                ...
                // 判断是否在23:55:00之后
                if ((currentHours === 23 && currentMinutes >= 55 && currentSeconds >= 0)) {
                    if (e.ctrlKey && e.keyCode === 13) {
                        var val = prompt("&#8203;``【oaicite:0】``&#8203;设置刷新间隔，单位毫秒 (别太过分，最低500)：", 100);
                        val = parseInt(val, 10);
    ...
    if (reg_order.test(pageurl)) {
        ...
        $(document).keydown(
            function (e) {
                ...
                if ((currentHours === 23 && currentMinutes >= 55 && currentSeconds >= 0)) {
                    if (e.ctrlKey && e.keyCode === 13) {
                        var val = prompt("&#8203;``【oaicite:0】``&#8203;设置刷新间隔，单位毫秒 (别太过分，最低500)：", 1000);
                        val = parseInt(val, 10);
